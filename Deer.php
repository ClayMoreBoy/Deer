        ...
        <ul class="rslides" id="slider4">
            <li>
                <div class="banner-1">
                    <div class="container">
                        <div class="logo">
                            <a href="<?php $this->options->siteUrl(); ?>"><img src="<?php if ($this->options->logoUrl){$this->options->logoUrl();}else{$this->options->themeUrl('logo.png');} ?>" alt="<?php $this->options->title(); ?>" /></a>
                        </div>
...
<?php $this->widget('Widget_Contents_Page_List')->to($pages); ?>
          ...
          <!-- script for menu -->
            ...
            <div class="header-right">
                <ul>
                    <li><a href="<?php if ($this->options->Bulletinsite){$this->options->Bulletinsite();} ?>" target="_blank"><span class="Bulletin"></span></a></li>
                    <li><a href="<?php if ($this->options->Sitemapsite){$this->options->Sitemapsite();} ?>" target="_blank"><span class="Sitemap"></span></a></li>
...
<div class="skills"><div class="percentage"></div><div class="clear"></div></div>
